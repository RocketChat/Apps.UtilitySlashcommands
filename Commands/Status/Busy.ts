...
export class Busy implements ISlashCommand {
  public command: string = 'busy';
  public i18nDescription: string = 'status_busy_description';
  public i18nParamsExample: string = 'status_busy_params';
  ...
  public async executor(context: SlashCommandContext, read: IRead, modify: IModify): Promise<void> {
    return await changeStatus(modify, context.getSender(), UserStatusConnection.BUSY);
  }
}
