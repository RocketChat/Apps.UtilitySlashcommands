...
export class Online implements ISlashCommand {
  public command: string = 'online';
  public i18nDescription: string = 'status_online_description';
  public i18nParamsExample: string = 'status_online_params';
  ...
  public async executor(context: SlashCommandContext, read: IRead, modify: IModify): Promise<void> {
    return await changeStatus(modify, context.getSender(), UserStatusConnection.ONLINE);
  }
}
