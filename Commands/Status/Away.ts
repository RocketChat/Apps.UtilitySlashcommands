...
export class Away implements ISlashCommand {
  public command: string = 'away';
  public i18nDescription: string = 'status_away_description';
  public i18nParamsExample: string = 'status_away_params';
  ...
  public async executor(context: SlashCommandContext, read: IRead, modify: IModify): Promise<void> {
    return await changeStatus(modify, context.getSender(), UserStatusConnection.AWAY);
  }
}
